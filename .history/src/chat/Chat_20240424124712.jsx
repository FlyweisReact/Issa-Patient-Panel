...
const Chat = () => {
  ...
  const fetchChatDocumentsRealtime = () => {
    const chatCollectionRef = collection(db, process.env.React_App_Firebase_CollectionName);
  ...
  const fetchDocumentByIdRealtime = (documentId) => {
    const docRef = doc(db, process.env.React_App_Firebase_CollectionName, documentId);
  ...
  const updateChat = async (e) => {
    e.preventDefault();
    const documentRef = doc(db, "PatientChat", documentId);
